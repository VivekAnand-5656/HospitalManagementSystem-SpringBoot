...
//        OAuth2AccessToken jwt = (OAuth2AccessToken) authentication;
        ...
        ResponseEntity<LoginResponseDTO> loginResponseDTOResponseEntity = authService.handleOAuthLoginRequest(oAuth2User,
                registrationId);
